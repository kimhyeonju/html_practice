...
function change1(e){
    ...
    console.log(document.getElementsByName("check")[costRow-1]);
    var reCount = document.getElementsByName("check")[costRow-1].parentNode.parentNode.rows[6];
    var value = document.getElementsByName("check")[costRow-1].parentNode.parentNode.rows[6].value;
    console.log(value);
    reCount.innerHTML = "총 "+ (value-tag.value) + "개 남음";
